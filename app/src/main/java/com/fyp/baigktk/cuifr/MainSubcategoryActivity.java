...
import com.fyp.baigktk.cuifr.fragment.PostListFragment;
import com.fyp.baigktk.cuifr.fragment.RecentPostsFragment;
import com.fyp.baigktk.cuifr.fragment.RiderRequestsFragment;
...
public class MainSubcategoryActivity extends MainActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // If showing Ride Request Posts, then uszer is a Driver:
        if (mPostType == Post.PostType.RIDER) { // if (postType) {
            setContentView(R.layout.activity_1_driver_main);
            getSupportFragmentManager().beginTransaction().replace(R.id.xyz,
                    new RiderRequestsFragment()).commit();
